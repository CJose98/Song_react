...
export default function IdArtistaSong({ id_song_p, nom_b}) {
    ...
    if (isError) return <p>Error al cargar las musicas de artista</p>
    if (!data) return <p>No hay musica de artista disponible</p>
    ...
    const handleModificar = (subId) => {
        navigate(`/artista-song-update/${subId}`);
    }
